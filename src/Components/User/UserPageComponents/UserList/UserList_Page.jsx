...
import { loginAtom, userInfoAtom } from '../../../../Recoil/Atom';
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead >
          <TableRow sx={{maxHeight: '10px', bgcolor: "#F0F4FB", fontWeight: "bold"}}>
            <TableCell align="center" rowSpan={2} width='5%'>번호</TableCell>
            <TableCell align="center" rowSpan={2} width='8%'>유형</TableCell>
            <TableCell align="center" rowSpan={2} width='8%'>이름</TableCell>
            <TableCell align="center" rowSpan={2} width='9%'>소속</TableCell>
            <TableCell align="center" rowSpan={2} width='10%'>이메일(아이디)</TableCell>
            <TableCell align="center" colSpan={5} width='28%'>상세정보 접근권한</TableCell>
            <TableCell align="center" rowSpan={2} width='10%'>이용중인<br/>서비스</TableCell>
            <TableCell align="center" rowSpan={2} width='10%'>등록일자</TableCell>
            <TableCell align="center" rowSpan={2} width='5%'>상태</TableCell>
            <TableCell align="center" rowSpan={2} width='4%'>삭제</TableCell>
            
          </TableRow>
          <TableRow sx={{ bgcolor: "#F0F4FB", fontWeight: "bold", height:"30px" }}>
            <TableCell align="center" >블록</TableCell>
            <TableCell align="center" >대시<br/>보드</TableCell>
            <TableCell align="center" >트랜<br/>잭션</TableCell>
        ...
        <TableBody>
          {userlist.map((user, idx) => (
            <TableRow
              key={idx} onClick={(e) => onClickHandler(user.uid, e)}
